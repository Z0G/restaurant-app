...
export const menuItems = [
  ...
  { id: 1, name: 'Margherita Pizza', price: 15.99, description: 'Fresh mozzarella, tomato sauce, and fresh basil on wood-fired crust', category_id: 4, category_name: 'Pasta & Pizza', restaurant_id: 1, restaurant_name: 'Bella Italia', recipe_id: 1, is_available: true },
  { id: 2, name: 'Spaghetti Carbonara', price: 17.99, description: 'Classic pasta with pancetta, eggs, and parmesan cheese', category_id: 4, category_name: 'Pasta & Pizza', restaurant_id: 1, restaurant_name: 'Bella Italia', recipe_id: 2, is_available: true },
  { id: 3, name: 'Chicken Parmesan', price: 19.99, description: 'Breaded chicken with marinara and fresh mozzarella', category_id: 3, category_name: 'Main Courses', restaurant_id: 1, restaurant_name: 'Bella Italia', recipe_id: 3, is_available: true },
  { id: 4, name: 'Tiramisu', price: 7.99, description: 'Classic Italian coffee-flavored dessert with mascarpone', category_id: 8, category_name: 'Desserts', restaurant_id: 1, restaurant_name: 'Bella Italia', recipe_id: 4, is_available: true },

  // Sakura Sushi - Japanese Restaurant
  { id: 5, name: 'Sushi Platter', price: 28.99, description: 'Assorted fresh sushi and sashimi with wasabi and ginger', category_id: 6, category_name: 'Asian Cuisine', restaurant_id: 2, restaurant_name: 'Sakura Sushi', recipe_id: 5, is_available: true },
  { id: 6, name: 'Chicken Teriyaki', price: 18.99, description: 'Grilled chicken with teriyaki glaze and steamed rice', category_id: 6, category_name: 'Asian Cuisine', restaurant_id: 2, restaurant_name: 'Sakura Sushi', recipe_id: 6, is_available: true },
  { id: 7, name: 'Ramen Bowl', price: 13.99, description: 'Rich pork broth with noodles, egg, and fresh toppings', category_id: 6, category_name: 'Asian Cuisine', restaurant_id: 2, restaurant_name: 'Sakura Sushi', recipe_id: 7, is_available: true },
  { id: 8, name: 'Miso Soup', price: 4.99, description: 'Traditional soybean paste soup with tofu and seaweed', category_id: 2, category_name: 'Soups & Salads', restaurant_id: 2, restaurant_name: 'Sakura Sushi', recipe_id: null, is_available: true },

  // El Mariachi - Mexican Restaurant
  { id: 9, name: 'Tacos Al Pastor', price: 12.99, description: 'Marinated pork with pineapple, onions, and cilantro', category_id: 7, category_name: 'Mexican', restaurant_id: 3, restaurant_name: 'El Mariachi', recipe_id: 8, is_available: true },
  { id: 10, name: 'Chicken Fajitas', price: 17.99, description: 'Sizzling chicken with peppers, onions, and tortillas', category_id: 7, category_name: 'Mexican', restaurant_id: 3, restaurant_name: 'El Mariachi', recipe_id: 9, is_available: true },
  { id: 11, name: 'Guacamole & Chips', price: 8.99, description: 'Fresh avocado dip with crispy tortilla chips', category_id: 1, category_name: 'Appetizers', restaurant_id: 3, restaurant_name: 'El Mariachi', recipe_id: 10, is_available: true },
  { id: 12, name: 'Churros', price: 6.99, description: 'Fried dough sticks with cinnamon sugar and chocolate sauce', category_id: 8, category_name: 'Desserts', restaurant_id: 3, restaurant_name: 'El Mariachi', recipe_id: null, is_available: true },

  // Ocean's Bounty - Seafood Restaurant
  { id: 13, name: 'Grilled Salmon', price: 24.99, description: 'Atlantic salmon with lemon herb butter and vegetables', category_id: 5, category_name: 'Seafood', restaurant_id: 4, restaurant_name: "Ocean's Bounty", recipe_id: 11, is_available: true },
  { id: 14, name: 'Fish Tacos', price: 16.99, description: 'Grilled mahi-mahi with cabbage slaw and lime crema', category_id: 5, category_name: 'Seafood', restaurant_id: 4, restaurant_name: "Ocean's Bounty", recipe_id: 12, is_available: true },
  { id: 15, name: 'Crab Cakes', price: 24.99, description: 'Maryland-style crab cakes with spicy remoulade', category_id: 5, category_name: 'Seafood', restaurant_id: 4, restaurant_name: "Ocean's Bounty", recipe_id: 13, is_available: true },
  { id: 16, name: 'Seafood Paella', price: 29.99, description: 'Traditional Spanish rice with mixed seafood and saffron', category_id: 5, category_name: 'Seafood', restaurant_id: 4, restaurant_name: "Ocean's Bounty", recipe_id: null, is_available: true },

  // Garden Fresh - Healthy Restaurant
  { id: 17, name: 'Caesar Salad', price: 12.99, description: 'Fresh romaine with caesar dressing and garlic croutons', category_id: 2, category_name: 'Soups & Salads', restaurant_id: 5, restaurant_name: 'Garden Fresh', recipe_id: 14, is_available: true },
  { id: 18, name: 'Mediterranean Bowl', price: 14.99, description: 'Quinoa bowl with feta, olives, and herb vinaigrette', category_id: 2, category_name: 'Soups & Salads', restaurant_id: 5, restaurant_name: 'Garden Fresh', recipe_id: 15, is_available: true },
  { id: 19, name: 'Grilled Chicken Wrap', price: 11.99, description: 'Healthy wrap with grilled chicken and fresh vegetables', category_id: 3, category_name: 'Main Courses', restaurant_id: 5, restaurant_name: 'Garden Fresh', recipe_id: null, is_available: true },
  { id: 20, name: 'Fresh Fruit Bowl', price: 8.99, description: 'Seasonal fresh fruits with honey and mint', category_id: 8, category_name: 'Desserts', restaurant_id: 5, restaurant_name: 'Garden Fresh', recipe_id: null, is_available: true }
];
